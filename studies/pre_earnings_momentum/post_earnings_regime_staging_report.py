"""Atomic Study 6 artifact writer with an ETF-aware schema."""
...
DAILY_COLUMNS = [
    ...
    "spxl_market_value", "total_equity", "net_liquidation_value",
    "benchmark_value", "benchmark_net_liquidation_value",
    "stock_exposure_pct", "spy_exposure_pct", "spxl_exposure_pct",
    "cash_exposure_pct", "etf_exposure_proxy", "stock_position_count",
    "etf_symbol", "etf_shares", "daily_market_regime",
    "last_executable_weekly_regime", "cumulative_stock_costs",
    "cumulative_etf_costs", "realized_stock_pl", "realized_etf_pl", "drawdown",
]
...
def _report(result: RegimeStagingResult) -> str:
    ...
    return "\n".join([
        ...
        f"- Passive SPY close value: {stats['benchmark_value']}",
        f"- Passive SPY net-liquidation value: {stats['benchmark_net_liquidation_value']}",
