# smallFish — project status

What is still active, awaiting real-world evidence, or decided-and-closed.
Nothing here is a record of finished work: completed implementation lives in
the code, and the durable contracts it satisfies are documented in
...
plans and phase documents have been retired.
