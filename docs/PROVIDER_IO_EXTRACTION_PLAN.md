...
**Status:** Complete. Provider I/O is confined to `services/`; automated gates,
owner-authorized read-only provider verification, and one Tastytrade and
Fidelity UI sync have passed.
