...
|---|---|---|---|---|
| 0 | Boundary characterization and two corrective fixes | NOT STARTED | Terra begins here after owner handoff | — |
| 1 | Shared Tastytrade I/O for backend | NOT STARTED | Phase 0 must pass | — |
