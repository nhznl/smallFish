...
| 5 | First shared Trading/Retirement UI slice | NOT STARTED | Depends on Phase 4; owner UI checkpoint after commit | - |
| 6 | History/reset UX and shared UI consolidation | NOT STARTED | Blocked until owner approves Phase 5 | - |
