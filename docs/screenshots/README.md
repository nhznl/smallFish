...
| `options-basis-connected.png` | `/options` → Combined Adjusted Basis | 1440×1400 | Trading Combined Adjusted Basis with the same three synthetic underlyings: combined equity and option P/L, plus live option-adjusted basis per share. |
