...
def test_fully_covered_short_call_is_retyped_and_stays_short_for_risk():
    rows = [_call(qty=2)]
    ...
    # Retyping must not change how the risk engine treats the position.
    assert COVERED_CALL in SHORT_OPTION_TYPES
